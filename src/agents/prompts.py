...
_COORDINATION_PROMPT = (
    ...
    "MESSAGE MODEL: Replies may arrive asynchronously as events, not in strict lockstep rounds. "
    "Treat each incoming message as new context and decide independently whether to respond.\n"
    "Respond only when you add net-new value (new evidence, a concrete decision, or a specific action). "
    "If no action is needed, respond with exactly [PASS].\n"
    "Avoid repeating prior shares unless you are correcting, refining, or extending them."
)
