  ...
  switch (msg.type) {
    ...
    case "user_message": {
      const userMsg: Message = {
        ...
        round_number: null, passed: false, created_at: new Date().toISOString(),
      };
    ...
    case "agent_notice": {
      const noticeMsg: Message = {
        ...
        round_number: state.currentRound || null, passed: false, created_at: new Date().toISOString(),
      };
    ...
    case "agent_completed": {
      ...
      const agentMsg: Message = {
        ...
        round_number: state.currentRound, passed: msg.passed, created_at: new Date().toISOString(),
